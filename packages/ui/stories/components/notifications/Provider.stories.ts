...
const meta = {
  ...
  args: {
    horizontal: 'center' satisfies ToastsDisplayPlacementHorizontal,
    vertical: 'top' satisfies ToastsDisplayPlacementVertical,
  },
  argTypes: {
    horizontal: {
      control: 'inline-radio',
      options: ['left', 'center', 'right'] satisfies ToastsDisplayPlacementHorizontal[],
    },
    vertical: {
      control: 'inline-radio',
      options: ['top', 'bottom'] satisfies ToastsDisplayPlacementVertical[],
    },
  },
} satisfies Meta
